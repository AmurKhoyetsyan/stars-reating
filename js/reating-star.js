    ...
    StarReating.prototype.createStar = function () {
        ...
        if (parents) {
            parents.forEach((item, index) => {
                ...
                let cursorPoint = item.querySelector('.arm-star-reting-content-star');

                cursorPoint.onmouseover = function (event) {
                    let child = item.querySelector('.arm-star-reting-mask');
                ...
                cursorPoint.onmouseout = function (event) {
                    let child = item.querySelector('.arm-star-reting-mask');
                    let rect = item.querySelector(`.arm-star-reting-progress-star-${index}`);
                    setTimeout(() => {
